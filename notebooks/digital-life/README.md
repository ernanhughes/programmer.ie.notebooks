...
Chapters 26-30 complete the main Digital Life notebook companion. They keep the final scientific record executable without rerunning expensive canonical experiments in quick mode: Chapter 26 separates causal routing from causal amplification, Chapter 27 preserves invalid/supported/unresolved construct distinctions, Chapter 28 separates raw causal containment from privileged individuation, Chapter 29 audits the failure ledger, and Chapter 30 synthesizes the provisional substrate-first specification. Every main chapter 00-30 now has a notebook; appendices are intentionally not included.
